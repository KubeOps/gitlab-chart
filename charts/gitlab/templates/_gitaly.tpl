...
{{- if (index (coalesce .Values.gitaly.external .Values.global.gitaly.external) .index).hostname -}}
...
{{- if (index (coalesce .Values.gitaly.external .Values.global.gitaly.external) .index).port -}}
