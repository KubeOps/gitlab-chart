...
{{- /**
     ...
     *  selector, or otherwise you will have conflicting selectors, which will result in potentially broken
     *  applications and degraded performance accross the whole cluster.
     ...
     *  template value injection via the "name" template or the .Release.Name field's value, and fail if such behaviour
     *  is tried.
     */ -}}
